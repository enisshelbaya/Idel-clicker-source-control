...
draw_text(room_width / 2, o_click_power_500.y-180, "Count:" + string(global.stats.counter_click_power.counter_click_power_500));
if (global.stats.cost_click.cost_click_power_500 < 999999) 
{
draw_text(room_width / 2, o_click_power_500.y+100, "Cost:" + string(global.stats.cost_click.cost_click_power_500));
}
else 
{
