...
draw_text_transformed(view_wport[0] *0.230,y+(view_hport[0]*0.05), "Cost: $20.01" ,2*(view_wport[0]/768),2*(view_wport[0]/768),0);
draw_set_valign(fa_top)
draw_set_font(Font4)
draw_text_transformed(view_wport[0]*0.230,y-(view_hport[0]*0.05), "500 Diamonds",1.5*(view_wport[0]/768),1.5*(view_wport[0]/768),0)
