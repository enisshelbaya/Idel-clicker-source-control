...
draw_text_transformed(view_wport[0]*0.5,view_hport[0]*0.08,  number_abbreviated+ " Chunks" ,1*(view_wport[0]/768),1*(view_wport[0]/768),0);
}
else {
	draw_text_transformed(view_wport[0]*0.5,view_hport[0]*0.08,  string(floor(global.stats.random_vars.Currency_amount))+ " Cookies" , 1*(view_wport[0]/768),1*(view_wport[0]/768),0);
}
