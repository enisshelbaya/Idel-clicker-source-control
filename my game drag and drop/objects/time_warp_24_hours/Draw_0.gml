...
draw_line_width(view_wport[0]*0.01,view_hport[0]*0.20,view_wport[0]*0.01,view_hport[0]*0.39,view_hport[0]*0.01)
draw_line_width(view_wport[0]*0.99,view_hport[0]*0.20,view_wport[0]*0.99,view_hport[0]*0.39,view_hport[0]*0.01)
